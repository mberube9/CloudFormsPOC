###################################
#
# CFME Automate Method: RunProgramInGuest_Windows
#
...
begin
  ...
  def log(level, message, update_message=false)
    @method = 'RunProgramInGuest_Windows'
  ...
  unless @vm.operating_system[:product_name].downcase.include?('windows') && @vm.vendor.downcase == 'vmware'
